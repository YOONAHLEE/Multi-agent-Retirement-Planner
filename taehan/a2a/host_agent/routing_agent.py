...
class RoutingAgent:
    ...
    def create_agent(self) -> Agent:
        ...
        return Agent(
            ...
            description=(
                'This Routing agent orchestrates the decomposition of the user asking for retirement pension information or tax strategy consultation'
            ),
            tools=[
                self.send_message,
            ],
    ...
    def root_instruction(self, context: ReadonlyContext) -> str:
        ...
        return f"""
        **Role:** You are an expert Routing Delegator. Your primary function is to accurately delegate user inquiries regarding retirement pension or tax strategies to the appropriate specialized remote agents.
    ...
    async def _async_main() -> Agent:
        routing_agent_instance = await RoutingAgent.create(
            remote_agent_addresses=[
                os.getenv('INFO_AGENT_URL', 'http://localhost:10000'),
                os.getenv('TAX_AGENT_URL', 'http://localhost:10001'),
                os.getenv('REPORT_AGENT_URL', 'http://localhost:10002'),
            ]
        )
